        ...
        <div id="brokers">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>${clusterSummary.getBrokerLeaderPartitionCount(b.id)} (${(clusterSummary.getBrokerLeaderPartitionCount(b.id)/clusterSummary.partitionCount)?string.percent})</td>
                </tr>
                </#list>
                </tbody>
            </table>
